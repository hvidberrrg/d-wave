...
def exact_sample(bqm: dimod.BinaryQuadraticModel) -> dict[int, int]:
    """Ask the exact solver to return the solution for the supplied binary quadratic model
    ...
    Args:
        ...
        Returns:
            A dictionary mapping the location of each element in the input "vector" to the
            corresponding 0/1 value returned by the solver
    """
